...
{
	Stage08::Stage08(const std::vector<BoardObjectInfo>& boardObjectInfos)
		: GameScene(eSceneType::STAGE08, eSceneType::STAGE09, 8u, 4u, 1.f, eSpriteType::StageName8, eSpriteType::PurpleTile, boardObjectInfos)
	{
	}
