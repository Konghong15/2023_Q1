...
{
	Stage06::Stage06(const std::vector<BoardObjectInfo>& boardObjectInfos)
		: GameScene(eSceneType::STAGE06, eSceneType::STAGE07, 8u, 5u, 1.f, eSpriteType::StageName6, eSpriteType::YellowTile, boardObjectInfos)
	{
	}

	void Stage06::CreateBoardObject()
	{
