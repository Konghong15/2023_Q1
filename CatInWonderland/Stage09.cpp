...
{
	Stage09::Stage09(const std::vector<BoardObjectInfo>& boardObjectInfos)
		: GameScene(eSceneType::STAGE09, eSceneType::STAGE10, 8u, 5u, 1.f, eSpriteType::StageName9, eSpriteType::PurpleTile, boardObjectInfos)
	{
	}

	void Stage09::CreateBoardObject()
	{
