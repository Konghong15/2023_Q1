...
{
	Stage07::Stage07(const std::vector<BoardObjectInfo>& boardObjectInfos)
		: GameScene(eSceneType::STAGE07, eSceneType::STAGE08, 8u, 5u, 1.f, eSpriteType::StageName7, eSpriteType::YellowTile, boardObjectInfos)
	{
	}

	void Stage07::CreateBoardObject()
	{
